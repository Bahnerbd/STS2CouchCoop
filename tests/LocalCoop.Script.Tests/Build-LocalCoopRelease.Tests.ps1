    ...
    @'
{
  ...
  "name": "Local Co-op",
  "author": "bahne + Codex",
  "description": "Portable test manifest.",
  "version": "0.1.0",
  "has_pck": false,
  "has_dll": true,
  "dependencies": [],
...
'@ | Set-Content -LiteralPath $manifestPath
    ...
    Assert-Equal $manifest.name 'Local Co-op' 'Manifest name should be preserved.'
    ...
    Set-Content -LiteralPath (Join-Path $packageRoot 'LocalCoop.json') -Value '{}'
